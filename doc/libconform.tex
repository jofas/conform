...
CP is easily modified to being an abstaining classifier.
...
classifier $B$. The meta data being 0 if $B$'s prediction
for an observation $x_i$ was wrong, 1 if it was correct.
...
% internal threshold T for pp / pn
